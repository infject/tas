...
function handleCardClick(card, isMyTurn) {
  ...
  if (targeting) return showMessage("Already selecting a target.");
  if (card.cost > latestYourData.resonance) return showMessage("Not enough resonance!");

  const targetRequired = ["Echo Drain","Layer Shift","Collapse","Dissolve","Unseen Echo","Frequency Swap","Timeline Lock","Residual Echo","Layer Fusion"];
