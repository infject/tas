...
const cards = [
  {
    ...
    type: "Spell",
    cost: 2,
    effect: "Target player loses 2 stability; gain 2 resonance",
  ...
  },
  {
    ...
    action: (player, target) => { if (target) { target.skipTurn = true; target.locked = true; } }
  },
  {
    id: 6,
    name: "Resonant Pulse",
  ...
  },
  {
    ...
    type: "Spell",
    cost: 2,
    effect: "Lose 1 resonance to make target lose 2 stability",
    action: (player, target) => {
      applyResonance(player, -1);
      if (target) applyStability(target, -2);
    }
  },
  {
    id: 30,
    ...
    type: "Event",
    cost: 5,
    effect: "Gain 2 stability and reset resonance to 3",
    action: (player) => {
      applyStability(player, +2);
      player.resonance = 3;
    }
